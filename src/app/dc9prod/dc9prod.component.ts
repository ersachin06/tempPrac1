...
@Component({
  selector: 'app-dc9prod',
  templateUrl: './dc9prod.component.html',
  styleUrls: ['./dc9prod.component.css']
})
export class Dc9prodComponent implements OnInit {
  ...
  {
    alert(prodInfo.status+"  "+ prodInfo.prating11);
  }
}
